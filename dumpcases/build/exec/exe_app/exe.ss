...
(define Main-numero3 (lambda (arg-0) (Main-double2 (vector (lambda (arg-5756) (lambda (arg-5759) (+ arg-5756 arg-5759))) (lambda (arg-5766) (lambda (arg-5769) (* arg-5766 arg-5769))) (lambda (arg-5776) (exact->inexact arg-5776))) arg-0)))
(define Main-numero2 (lambda (arg-0) (Main-double2 (vector (lambda (arg-5756) (lambda (arg-5759) (+ arg-5756 arg-5759))) (lambda (arg-5766) (lambda (arg-5769) (* arg-5766 arg-5769))) (lambda (arg-5776) arg-5776)) arg-0)))
(define Main-numero (lambda (arg-0) (+ arg-0 arg-0)))
(define Main-minimo (lambda (arg-0 arg-1) (let ((sc0 (PreludeC-45EqOrd-u--C-62_Ord_Integer arg-0 arg-1))) (cond ((equal? sc0 1) arg-1) (else arg-0)))))
(define Main-main(blodwen-lazy (lambda () (PreludeC-45IO-putStrLn (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8737) (PreludeC-45IO-u--map_Functor_IO u--func arg-8737))))) (lambda (u--a) (lambda (arg-9440) (lambda (eta-0) arg-9440))) (lambda (u--b) (lambda (u--a) (lambda (arg-9446) (lambda (arg-9453) (PrimIO-io_bind arg-9446 (lambda (u--fC-39) (PrimIO-io_bind arg-9453 (lambda (u--aC-39) (lambda (eta-0) (u--fC-39 u--aC-39))))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9920) (lambda (arg-9923) (PrimIO-io_bind arg-9920 arg-9923))))) (lambda (u--a) (lambda (arg-9934) (PrimIO-io_bind arg-9934 (lambda (eta-0) eta-0))))) (lambda (u--a) (lambda (arg-11999) arg-11999))) (string-append (PreludeC-45Show-u--show_Show_Integer (Main-numero 3)) (string-append (PreludeC-45Show-u--show_Show_Integer (Main-numero2 5)) (string-append (PreludeC-45Show-u--show_Show_Double (Main-numero3 7.1)) (PreludeC-45Show-u--show_Show_Integer (Main-minimo 1 0)))))))))
(define Main-double2 (lambda (arg-1 arg-2) (let ((e-1 (vector-ref arg-1 0))) ((e-1 arg-2) arg-2))))
