...
;; @generated by Idris 0.5.1-68a144bf1, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define System-prim__usleep (lambda (farg-0 farg-1) ((foreign-procedure "idris2_usleep" (int) void) farg-0) (vector 0 )))
...
(define csegen-14(blodwen-lazy (lambda () (let ((eff-0 (lambda (eta-0) eta-0))) (lambda (arg-0) (eff-0 arg-0))))))
...
(define Main-main(blodwen-lazy (lambda () (Main-loop (State-initi)))))
(define Main-loop (lambda (arg-0) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (Main-PrintXY (lambda (eta-0) (PreludeC-45Cast-u--cast_Cast_Integer_Nat eta-0)) (State-coordinates arg-0) #\k)) (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (System-usleep (csegen-13) (PreludeC-45Cast-u--cast_Cast_Double_Int (/ ((csegen-14) 1000.0) ((csegen-14) 60.0))) (vector 0 )) (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (Main-eraseScreen)) (lambda () (Main-loop (State-update arg-0))))))))))
...
(define PreludeC-45Cast-u--cast_Cast_Integer_Nat (lambda (ext-0) (PreludeC-45Types-prim__integerToNat ext-0)))
(define PreludeC-45Cast-u--cast_Cast_Double_Int (lambda (ext-0) (exact-truncate-boundedInt ext-0 63)))
(define DataC-45String-singleton (lambda (arg-0) (string-cons arg-0 "")))
(define State-n--2658-964-u--castb (lambda (arg-0 arg-1) (cond ((equal? arg-1 0) -1) (else 1))))
(define State-update (lambda (arg-0) (let ((e-0 (vector-ref arg-0 0))) (let ((e-1 (vector-ref arg-0 1))) (vector e-0 e-1 (State-mover (State-rebota arg-0)))))))
(define State-rebota (lambda (arg-0) (let ((u--neobola (let ((e-2 (vector-ref arg-0 2))) e-2))) (let ((u--vx (* (let ((e-2 (vector-ref u--neobola 2))) e-2) (State-n--2658-964-u--castb arg-0 (let ((sc0 (PreludeC-45EqOrd-u--C-60C-61_Ord_Integer (let ((e-0 (vector-ref u--neobola 0))) e-0) (let ((e-0 (vector-ref arg-0 0))) e-0)))) (cond ((equal? sc0 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Integer (let ((e-0 (vector-ref u--neobola 0))) e-0) 1)) (else 0))))))) (let ((u--vy (* (let ((e-3 (vector-ref u--neobola 3))) e-3) (State-n--2658-964-u--castb arg-0 (let ((sc0 (PreludeC-45EqOrd-u--C-60C-61_Ord_Integer (let ((e-1 (vector-ref u--neobola 1))) e-1) (let ((e-1 (vector-ref arg-0 1))) e-1)))) (cond ((equal? sc0 1) (PreludeC-45EqOrd-u--C-62C-61_Ord_Integer (let ((e-1 (vector-ref u--neobola 1))) e-1) 1)) (else 0))))))) (let ((e-0 (vector-ref u--neobola 0))) (let ((e-1 (vector-ref u--neobola 1))) (vector e-0 e-1 u--vx u--vy))))))))
(define State-mover (lambda (arg-0) (let ((e-2 (vector-ref arg-0 2))) (let ((e-3 (vector-ref arg-0 3))) (vector (+ (let ((e-7 (vector-ref arg-0 0))) e-7) (let ((e-5 (vector-ref arg-0 2))) e-5)) (+ (let ((e-6 (vector-ref arg-0 1))) e-6) (let ((e-4 (vector-ref arg-0 3))) e-4)) e-2 e-3)))))
(define State-initi(blodwen-lazy (lambda () (vector 15 15 (vector 2 2 1 1)))))
(define State-coordinates (lambda (arg-0) (cons (let ((e-2 (vector-ref arg-0 2))) (let ((e-6 (vector-ref e-2 0))) e-6)) (let ((e-2 (vector-ref arg-0 2))) (let ((e-5 (vector-ref e-2 1))) e-5)))))
(define Main-eraseScreen(blodwen-lazy (lambda () (ControlC-45ANSIC-45CSI-eraseScreen 2))))
(define Main-PrintXY (lambda (arg-1 arg-2 arg-3) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (string-append (ControlC-45ANSIC-45CSI-cursorMove ((let ((eff-0 arg-1)) (lambda (arg-0) (eff-0 arg-0))) e-3) ((let ((eff-0 arg-1)) (lambda (arg-0) (eff-0 arg-0))) e-2)) (DataC-45String-singleton arg-3))))))
(define ControlC-45ANSIC-45CSI-u--cast_Cast_EraseDirection_String (lambda (arg-0) (cond ((equal? arg-0 0) "1") ((equal? arg-0 1) "0") (else "2"))))
(define ControlC-45ANSIC-45CSI-eraseScreen (lambda (arg-0) (string-append "\x1b;[" (string-append (ControlC-45ANSIC-45CSI-u--cast_Cast_EraseDirection_String arg-0) "J"))))
(define ControlC-45ANSIC-45CSI-cursorMove (lambda (arg-0 arg-1) (string-append "\x1b;[" (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) (string-append ";" (string-append (PreludeC-45Show-u--show_Show_Nat arg-1) "H"))))))
